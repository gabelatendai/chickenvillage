 ...
 {{ csrf_field()}}
    ...
    <div class="form-body pal">
        <div class="form-group">
            <label for="inputName"  class="col-md-3 control-label pull-left"> Frequently Asked Questions</label>
            <div class="col-md-9"><div class="input-icon right">
                    <input id="name" type="text"placeholder="enter FAQ"  name="faq" class="form-control"  required /></div>
            </div></div>
    ...
    <div class="form-body pal">
        <div class="form-group">
            ...
            <div class="col-md-9"><div class="input-icon right">
                    <textarea id="" type="text" name="respond" cols="30" rows="10" class="form-control"  required ></textarea></div>
            </div></div>
